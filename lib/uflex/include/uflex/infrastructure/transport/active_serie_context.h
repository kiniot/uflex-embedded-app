 ...
 *
 * Symmetric to the up-channel MotionPayload. The firmware maps `activeJoint` to
 * an IMU pair, applies `maxSafeAngle` for local safety, and re-zeros the joint
 * angle when `serieId` changes (the guided-calibration handshake).
 *
